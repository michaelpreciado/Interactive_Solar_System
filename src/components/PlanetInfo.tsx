...
export const PlanetInfo: React.FC<PlanetInfoProps> = ({ planet }) => {
  ...
  return (
    <div className="liquid-glass-panel-compact w-64 p-3 animate-slide-in">
      <div className="flex justify-between items-start mb-3">
        <h2 className="text-sm font-bold text-white">{planet.name}</h2>
        <button
          onClick={handleClose}
          className="liquid-glass-close-compact"
          aria-label="Close"
        >
      ...
      <div className="space-y-2 text-xs">
        ...
        {/* Distance comparison */}
        <div className="liquid-glass-panel-compact p-2 rounded">
          <div className="flex items-center space-x-1 mb-2">
            <div className="w-1.5 h-1.5 bg-blue-400 rounded-full"></div>
            <div className="text-xs font-medium text-blue-200">Distance Info</div>
          </div>
          ...
          <div className="liquid-glass-panel-compact p-2 rounded">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center space-x-1">
                ...
                <h3 className="text-xs font-semibold text-purple-200">Moons</h3>
              </div>
              <div className="text-[10px] text-gray-400 bg-white/10 rounded px-1 py-0.5">
                {planet.moons.length}
              </div>
            </div>
